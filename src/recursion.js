...
var createArray = function(str) {
  if (str.length === 1) {
    return [].concat(str[0]);
  } else return [].concat(str[0], createArray(str.slice(1)))
};
...
var buildList = function(value, length) {
  ...
  if (length === 1) {
    ...
    } else return newArray.concat(value, buildList(value, length-1))
  }
  return newArray
};
...
var fizzBuzz = function(n) {
  ...
  if (n === 1) {
    ...
    if (n % 5 === 0 && n % 3 === 0) {
      return arr.concat(fizzBuzz(n-1), 'FizzBuzz')
    } else if (n % 5 === 0) {
      return arr.concat(fizzBuzz(n-1), 'Buzz')
    } else if (n % 3 === 0) {
      return arr.concat(fizzBuzz(n-1), 'Fizz')
    } else {
      return arr.concat(fizzBuzz(n-1), String(n))
    }
  }
};
...
var capitalizeWords = function(array) {
  if (array.length === 1) {
    return [].concat(array[0].toUpperCase());
  } else {
...
var capitalizeFirst = function(array) {
  if (array.length === 1) {
    return [].concat(array[0][0].toUpperCase() + array[0].substring(1));
  } else {
    return [].concat(array[0][0].toUpperCase()  + array[0].substring(1), capitalizeFirst(array.slice(1)))
  }
};
